from robotix.cognition.mind.free_energy.active_inference import ActiveInference
from robotix.cognition.mind.free_energy.active_inference import PreceptualInference
