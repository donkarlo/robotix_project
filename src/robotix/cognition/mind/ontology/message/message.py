from robotix.cognition.mind.ontology.message.interface import Interface
...
class Message(Interface):
    ...
    - How to build:
        ...
        - episodic is what ever that describes an entity, mental or physical. This description might cause generation of a command or a new description or discarded
    """
    def __init__(self):
        """
