from robotix.mind.cognition.process.kind.memory.composite.component import Component
from robotix.mind.cognition.process.kind.memory.composite.decorator.decorator import Decorator
