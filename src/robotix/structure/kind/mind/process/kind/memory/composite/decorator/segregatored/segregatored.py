from robotix.structure.kind.mind.process.kind.memory.composite.component import Component
from robotix.structure.kind.mind.process.kind.memory.composite.decorator.decorator import Decorator
