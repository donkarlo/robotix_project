...
class Trace(TraceInterface):
    """
    - trace is the connection between nervous system and mind. on one hand it receives potential activity fieelds and on theother hand it converts it to a nested data point such as a dictionary or a composite pattern
