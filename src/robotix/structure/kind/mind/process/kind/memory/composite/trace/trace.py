...
class Trace(TraceInterface):
    ...
    - the smalleast group part of the momery being generated by spikes sample_population field
    ...
    def __init__(self, population_activity_field: Optional[PopulationActivityField], name:Optional[str]):
        ...
        # it is just a point, a group point, without a sample_population it has no meaning
