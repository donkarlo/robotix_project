...
class Trace(TraceInterface):
    ...
    - the smalleast pair_set part of the momery being generated by spikes population field
    ...
    def __init__(self, population_activity_field: Optional[PopulationActivityField], name:Optional[str]):
        ...
        # it is just a point, a pair_set point, without a population it has no meaning
