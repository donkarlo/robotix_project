...
class Message(Interface):
    """Message is a group strcture such as a directed graph or oop_based objects or a tree graph that can be contributed to
    ...
    def init_from_language(self):
        """Such as describing a tree group structure"""
        pass
