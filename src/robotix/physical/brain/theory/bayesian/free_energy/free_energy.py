from robotix.physical.brain.theory.bayesian.free_energy.active_inference import ActiveInference
from robotix.physical.brain.theory.bayesian.free_energy.preceptual_inference import PreceptualInference
